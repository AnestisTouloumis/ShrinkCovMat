...
Each of the three implemented shrinkage covariance matrix estimators is a convex linear combination of the sample covariance matrix and of a target matrix. The core function is `shrinkcovmat` and the argument `target` defines one of the following three options: 
