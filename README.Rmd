...
This package provides the nonparametric Stein-type shrinkage estimates of the covariance matrix proposed by @Touloumis2015. These estimates are suitable and statistically efficient regardless of the dimensionality.
